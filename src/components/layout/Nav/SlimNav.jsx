...
class SlimNavComponent extends NavBase {
  ...
  _getScrollTop() {
    ...
    const navScroller = document.getElementById(this.props.navScrollerId);
  ...
  _getFloatingNav(parentElement) {
    ...
    return parentElement.querySelector("[data-floating-nav]");
  }
  ...
  _renderGroup(group, groupIndex) {
    ...
    if (!enableCustomization && group.groupType === "CustomizationGroup") {
      return null;
    }
